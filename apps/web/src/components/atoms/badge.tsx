...
export const badgeVariants = cva(`
  ...
  has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&>svg]:size-3! group/badge
    ...
    variants: {
      variant: {
        ...
        destructive: `
          ...
          dark:focus-visible:ring-destructive/40 text-destructive dark:bg-destructive/20`,
        outline: `
